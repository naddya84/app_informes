...
function cargar_pendientes(){ 
  fetch('fragmentos/lista_pendientes.php?pagina_actual='+pagina_actual+busqueda,  {
    method: 'GET',
...
function cargar_en_proceso(){ 
  fetch('fragmentos/lista_en_proceso.php?pagina_actual='+pagina_actual+busqueda,  {
    method: 'GET',
    credentials: 'same-origin',    
    mode: 'no-cors',
    headers:{
...
function cargar_finalizados(){ 
  fetch('fragmentos/lista_finalizados.php?pagina_actual='+pagina_actual+busqueda,  {
    method: 'GET',
    credentials: 'same-origin',    
    mode: 'no-cors',
    headers:{
