...
<html>
  <head>
    ...
    <script src="js/reporte_informe_pendiente.js?v=1"></script>
  ...
  <div class="container-fluid">
      ...
      <div class="fondo_central">
        ...
        <div class="contenedor_datos_reporte">
          ...
          <div class="center"><h4 class="color_plomo">Reporte de Informes Pendientes</h4></div>
        ...
        if (count($informes) <= 0) {
          ...
          foreach ($informes as $informe) {
            ...
            <div class="row css_row">
              ...
              <div class="col-lg"><?=$informe->avance>0?$informe->avance." %":"-"?></div>
